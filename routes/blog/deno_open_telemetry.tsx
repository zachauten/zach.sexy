  ...
  return (
    <>
      ...
      <article>
        ...
        <p>
          Then open the home page in a browser. Log in to Honeycomb and we
          should see the data showing up under a dataset named "fresh-project",
          or whatever name was used for{" "}
        </p>
        ...
        <img
          alt="screenshot of honeycomb.io showing traces generated by Deno"
          src={asset("/img/demo-traces-1.webp")}
        />
        <p>We can also see logs from the server's startup.</p>
        <img
          alt="screenshot of honeycomb.io showing some startup logs"
          src={asset("/img/demo-logs.webp")}
        />
        <p>
        ...
        <img
          alt="screenshot of honeycomb.io showing some traces with multiple spans generated by the browser"
          src={asset("/img/demo-traces-2.webp")}
        />
        {
          // Demo:
          //
